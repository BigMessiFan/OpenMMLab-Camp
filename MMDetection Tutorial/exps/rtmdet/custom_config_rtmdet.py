...
default_hooks = dict(
    ...
    visualization=dict(
        type='DetVisualizationHook', draw=True, test_out_dir='result'))
env_cfg = dict(
...
log_level = 'INFO'
load_from = 'exps/rtmdet/best_coco/bbox_mAP_epoch_30.pth'
resume = False
train_cfg = dict(
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='data/balloon/val/val_coco.json',
    metric=['bbox', 'segm'],
    format_only=False,
    backend_args=None,
